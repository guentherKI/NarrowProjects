...
if (!window.cheatLoaded) {
    ...
    async function InjectProps() {
        ...
        let chatLoggerScript = document.createElement("script");
        chatLoggerScript.innerHTML = ipcRenderer.sendSync("client-getfile", "/Hooks/ChatLoggerHook.js");
        ...
        document.documentElement.insertBefore(chatLoggerScript, document.documentElement.firstChild);
    }
